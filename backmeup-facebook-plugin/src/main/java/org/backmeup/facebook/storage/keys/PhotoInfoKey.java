...
public enum PhotoInfoKey implements SerializerKey {
    ...
    public PhotoInfoKey[] getReduced() {
        return new PhotoInfoKey[] { PhotoInfoKey.NAME, LIKES, LIKES_FROM_PEOPLE, PLACE, TAGS, PhotoInfoKey.LOCATION, PhotoInfoKey.PUBLISH_DATE, PhotoInfoKey.FROM, PhotoInfoKey.IMAGES, ORIGINAL_LINK };
    }
}
...
public enum MasterParameter {    
    ...
    private MasterParameter(String values, Class<?> type) {
        this.param = Parameter.with("fields", values);
        this.type = type;
    }

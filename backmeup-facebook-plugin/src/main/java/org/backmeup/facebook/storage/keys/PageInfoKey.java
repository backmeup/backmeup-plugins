...
public enum PageInfoKey implements SerializerKey {
	...
	DIRECTOR("Filproduzent", Datatype.OTHER),
	EMAILS("EMails", Datatype.LIST),
	ENGAGEMENT("Sinn", Datatype.OTHER),
	FEATURED_VIDEO("Repräsentatioves Video", Datatype.OTHER),
	FEATURES("Funktionen des Fahrzeuges", Datatype.OTHER),
	...
	SEASON("Jahreszeit", Datatype.OTHER),

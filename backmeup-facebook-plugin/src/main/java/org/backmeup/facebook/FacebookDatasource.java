...
public class FacebookDatasource implements Datasource {
    ...
    public void downloadAll(PluginProfileDTO pluginProfile, PluginContext pluginContext, Storage storage, Progressable progressor)
        ...
        String CURRENT_ACCESSTOKEN = pluginProfile.getAuthData().getProperties().get(FacebookHelper.RT_PROPERTY_ACCESS_TOKEN);
        
        String tempDir = System.getProperty("java.io.tmpdir") + File.separator + "facebook_" + System.currentTimeMillis();

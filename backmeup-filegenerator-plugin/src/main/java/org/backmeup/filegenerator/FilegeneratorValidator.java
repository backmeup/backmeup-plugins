...
public class FilegeneratorValidator implements Validationable {
	...
	public List<RequiredInputField> getRequiredProperties() {
		...
		inputs.add(new RequiredInputField(Constants.PROP_GENERATOR_FILES, Constants.PROP_GENERATOR_FILES, Constants.PROP_GENERATOR_FILES_DESC, false, 8, Type.Number));
